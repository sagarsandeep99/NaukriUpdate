...
namespace NaukriJobUpdate
{
    public class SagarNaukri
    {
        ...
        public void Setup()
        {
            ...
            Thread.Sleep(2000);
            driver.FindElement(By.XPath("//input[@placeholder='Enter your active Email ID / Username']")).SendKeys("sagar.sandeep99@gmail.com");
            driver.FindElement(By.XPath("//input[@placeholder='Enter your password']")).SendKeys("Vaccations@1234");
        ...
        public void SagarNaukriTest()
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                ...
                if (!File.Exists(resumePath))
                {
                    ...
                    resumePath = Path.Combine(projectDir, "TestData", "Resumes", "Sagar.pdf");
                }
